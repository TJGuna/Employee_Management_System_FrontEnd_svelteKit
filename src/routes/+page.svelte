...
<div class="">
    <div class="px-6 pt-6 2xl:container">
        <div class="mb-6 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
            <div
                    class="relative dashboard-card flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md"
            >
                <div
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1">
                <div
                        class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white shadow-md"
                >
                    <svg
                            class="w-40 m-auto opacity-1"
                            viewBox="0 0 146 146"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                    >
            ...
            <div>
                <div
                        class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white shadow-md"
                >
            ...
            <div>
                <div
                        class="lg:h-full py-8 px-6 text-gray-600 rounded-xl shadow-md border border-gray-200 bg-white"
                >
                    <svg
                            class="w-40 m-auto"
                            viewBox="0 0 56 56"
